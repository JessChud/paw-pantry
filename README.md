...
- Give every active curated product and every shopping-intent record a tagged Amazon
  path. The 514 checked ASIN links remain identified as verified product links; the
...
seed has 521 stable records: 516 active products, five retained retired variants,
514 active checked Amazon product links, and no active Chewy links. The curated set
