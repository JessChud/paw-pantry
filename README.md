...
- Give every active curated product and every shopping-intent record a tagged Amazon
  path. The 256 checked ASIN links remain identified as verified product links; the
...
seed has 263 stable records: 258 active products, five retained retired variants,
256 active checked Amazon product links, and no active Chewy links. The curated set
covers 17 species groupings and 18 supply categories. A separate 2,771-record shopping-intent
